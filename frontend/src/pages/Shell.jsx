          ...
          {view === "dashboard" ? (
            <div>
              <div className="mb-5 flex items-center justify-between">
                <div>
                  <h1 className="font-display text-2xl font-semibold text-ink">{persona.label} Dashboard</h1>
                  <p className="text-sm text-muted">Live data from the XYZ AI backend, not hardcoded.</p>
                </div>
              ...
              {dashboardData && DashboardComponent && <DashboardComponent data={dashboardData.data} />}
            </div>
          ) : (
